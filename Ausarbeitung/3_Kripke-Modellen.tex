...
Damit $C(\Phi)$ gilt, muss $E^k(\Phi)$ für beliebige k gelten.


Die beiden Defs müssen anders sein. Das sieht man daran, wenn man von (0,0,0) ausgeht und $E^1(\Phi)$ betrachtet. Oder wenn (0,0,0) der einzige Zustand ist, gilt $C(\Phi)$.
